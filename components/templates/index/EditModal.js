      ...
      <div className={styles.modal_content}>
        ...
        <form action="#" className={styles.edit_user_form}>
          <div className={styles.input_field}>
            ...
            <input type="text" placeholder="نام دوره" spellCheck="false" />
          </div>
          <div className={styles.input_field}>
            <span>
              <FontAwesomeIcon icon={faCashRegister} />{" "}
            </span>
            <input type="text" placeholder="قیمت دوره" spellCheck="false" />
          </div>
          <div className={styles.input_field}>
            <span>
              <FontAwesomeIcon icon={faUser} />
            </span>
            <input type="text" placeholder="مدرس دوره" spellCheck="false" />
          </div>
